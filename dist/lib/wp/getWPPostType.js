...
function getWPPostType(config, lang, options) {
  return (0, _makeRequest.default)(config, "/wp/v2/".concat(options.postType, "?per_page=").concat(config.perPage).concat(lang ? "&lang=".concat(lang) : ''), _objectSpread(_objectSpread({}, options), {}, {
